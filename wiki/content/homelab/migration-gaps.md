...
| dawarich | `dawarich/docker-compose.yml` | yes | no | yes |
| dockhand | `dockhand/docker-compose.yml` | yes | no | no |
| ebooks | `ebooks/docker-compose.yml` | yes | no | yes |
| frigate | `frigate/docker-compose.yml` | yes | no | no |
...
| linkstack | `linkstack/compose.yml` | yes | no | no |
...
| obsidian-livesync | `obsidian-livesync/docker-compose.yml` | yes | yes | no |
| obsidian-web | `obsidian-web/docker-compose.yml` | yes | no | yes |
| paperless-ngx | `paperless-ngx/docker-compose.yml` | yes | yes | yes |
| pingvin-share | `pingvin-share/docker-compose.yml` | yes | no | yes |
| portainer | `portainer/docker-compose.yml` | yes | no | no |
| sftp | `sftp/docker-compose.yml` | yes | yes | no |
| smtp-relay | `smtp-relay/docker-compose.yml` | yes | no | yes |
| spotify-stats | `spotify-stats/docker-compose.yml` | yes | yes | yes |
| stash | `stash/docker-compose.yml` | yes | no | no |
| timemachine | `timemachine/docker-compose.yml` | yes | no | yes |
| traefik | `traefik/docker-compose.yml` | yes | no | no |
| vault-inbox | `vault-inbox/docker-compose.yml` | yes | no | yes |
